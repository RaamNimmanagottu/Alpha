...
class TradingViewSignal:
    def get_Signal(symbol,ltp):
        ...
        lower_bound = Pivot - 15
        upper_bound = Pivot + 15
        ...
        print("StochasticSignal: ",StochasticSignal)
        print("CCI20Signal: ",CCI20Signal)
        print("ADXSignal: ",ADXSignal)
        print("AOSignal: ",AOSignal)
        print("MomSignal: ",MomSignal)
        # Decision logic
        if BUYCount > 1 and ((ADXSignal == "Strong Trend" or AOSignal == "Strong Trend") or MomSignal == "Uptrend" ):
            return "BUY",Pivot,Resistance,Support
        elif SellCount > 1 and ((ADXSignal == "Strong Trend" or AOSignal == "Strong Trend") or MomSignal == "Downtrend"):
